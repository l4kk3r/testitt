...
class App extends Component {
  ...
  render() {
    return (
      ...
      <h3>EN: Developed for monitoring live cryptocurrencies. If you want to convert crypto, contact us in Telegram: @pomidashboard💕</h3>
      <h3>RU: Разработано для отслеживания лайв-курса криптовалюты. Для обмена криптовалюты, свяжитесь с нами в Телеграмме: @pomidashboard💕</h3>
    </AppLayout>
    );
  }
}
